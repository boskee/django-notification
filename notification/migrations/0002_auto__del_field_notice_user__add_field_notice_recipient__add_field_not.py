...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notification_notice', 'recipient', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='recieved_notices', to=orm['auth.User']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Notice.user'
        raise RuntimeError("Cannot reverse this migration. 'Notice.user' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 19, 12, 48, 10, 389134)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 19, 12, 48, 10, 388960)'}),
